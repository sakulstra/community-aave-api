...
/**
 * Returns the income generated by the protocol.
 *
 * @remarks
 * We currently consider payments to the treasury(reserve factor fee), interest gained trough borrowing & flash loan fees as income.
 *
 * @returns The income by version and an additional totalIncome, summarizing all the versions.
 */
