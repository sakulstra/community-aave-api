...
export type ReserveLiquidityItemV2Fragment = { __typename?: "Reserve" } & Pick<
  Reserve,
  | "id"
  | "symbol"
  | "decimals"
...
export type ReserveHistoryLiquidityDataV2Fragment = {
  __typename?: "ReserveParamsHistoryItem";
} & Pick<
  ReserveParamsHistoryItem,
  | "id"
...
export type ReservesLiquidityQueryQuery = { __typename?: "Query" } & {
  reserves: Array<{ __typename?: "Reserve" } & ReserveLiquidityItemV2Fragment>;
};
...
`;
export const ReserveLiquidityItemV2FragmentDoc = gql`
...
`;
export const ReserveHistoryLiquidityDataV2FragmentDoc = gql`
...
export const ReservesLiquidityQueryDocument = gql`
  ...
  ${ReserveLiquidityItemV2FragmentDoc}
`;
export const ReserveParamsHistoryLiquidityItemsDocument = gql`
  ...
  ${ReserveHistoryLiquidityDataV2FragmentDoc}
`;
